...
class StockInFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_constraints' => [
            ...
            'stock_in_ibfk_2' => ['type' => 'foreign', 'columns' => ['user_id'], 'references' => ['users', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public $records = [
        [
            ...
            'product_id' => 1,
            'quantity' => 1,
            'created' => '2017-08-09 22:23:28',
            'modified' => '2017-08-09 22:23:28'
        ],
    ];
}
