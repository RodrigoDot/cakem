            ...
            <div class="box-body">
                <table class="table table-striped table-hover">
                    ...
                    <table class="table table-striped table-hover">
                        ...
                        <?php foreach ($user->adress as $adress): ?>
                        <tr>
                            <td><?= h($adress->id) ?></td>
                            <td><?= h($adress->user_id) ?></td>
                            <td><?= h($adress->nome_endereco) ?></td>
                            <td><?= h($adress->cep) ?></td>
                            <td><?= h($adress->rua) ?></td>
                            <td><?= h($adress->numero) ?></td>
                            <td><?= h($adress->bairro) ?></td>
                            <td><?= h($adress->cidade) ?></td>
                            <td><?= h($adress->uf) ?></td>
                            <td><?= h($adress->ibge) ?></td>
                            <td class="actions">
                                <?= $this->Html->link(__('View'), ['controller' => 'Adress', 'action' => 'view', $adress->id]) ?>
                                <?= $this->Html->link(__('Edit'), ['controller' => 'Adress', 'action' => 'edit', $adress->id]) ?>
                                <?= $this->Form->postLink(__('Delete'), ['controller' => 'Adress', 'action' => 'delete', $adress->id], ['confirm' => __('Are you sure you want to delete # {0}?', $adress->id)]) ?>
                            </td>
                        </tr>
                        <?php endforeach; ?>
                    </table>
                    ...
                    <h4><?= __('Related {0}', ['Categories Products']) ?></h4>
                    <table class="table table-striped table-hover">
                        <tr>
                                        <th>Id</th>
                                        <th>User Id</th>
                        ...
                        <tr>
                            <td><?= h($categoriesProducts->id) ?></td>
                            <td><?= h($categoriesProducts->user_id) ?></td>
                            <td><?= h($categoriesProducts->category_id) ?></td>
                            <td><?= h($categoriesProducts->product_id) ?></td>
                            <td class="actions">
